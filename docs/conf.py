...
latex_documents = [
    (master_doc, "brunns-matchers.tex", "brunns-matchers Documentation", "Simon Brunning", "manual"),
]
...
man_pages = [(master_doc, "brunns-matchers", "brunns-matchers Documentation", [author], 1)]
